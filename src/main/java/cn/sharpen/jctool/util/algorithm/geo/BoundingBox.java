...
public class BoundingBox implements Serializable {
    ...
    public void expandToInclude(WGS84Point point) {
        ...
        double distanceEastToPoint = remainderWithFix(point.getLongitude() - eastLongitude, 360);
        double distancePointToWest = remainderWithFix(westLongitude - point.getLongitude(), 360);
    ...
    public void expandToInclude(BoundingBox other) {
        ...
        // If this is not the case compute the distance between the endpoints in east direction
        double distanceEastToOtherEast = remainderWithFix(other.eastLongitude - eastLongitude, 360);
        double distanceOtherWestToWest = remainderWithFix(westLongitude - other.westLongitude, 360);
