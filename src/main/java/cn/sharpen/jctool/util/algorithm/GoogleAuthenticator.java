...
/**
 * google authenticator(谷歌验证码)工具
 * 参考： https://blog.csdn.net/lizhengjava/article/details/76947962#
 * @author justin
 */
public class GoogleAuthenticator {
    ...
    public static Boolean authCode(int windowSize, String codes, String savedSecret) {
    ...
    public static String getURL(String pre, String user, String host, String secret) {
        String format = "otpauth://totp/%s%s@%s?secret=%s";
